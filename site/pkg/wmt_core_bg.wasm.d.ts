...
export const wmtengine_belief_elicitation_prompt: (a: number, b: number, c: number, d: number) => [number, number];
...
export const wmtengine_reset: (a: number) => [number, number];
...
export const wmtengine_seed_scenario: (a: number) => [number, number];
